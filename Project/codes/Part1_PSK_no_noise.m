...
saveas(gcf,'../report/pics/p2-a-1.png')
%% Pulse Shaping
t_p = 0:1/fs:(pulse_N-1)/fs;
pulse1 = cos(2*pi*500*t_p);
pulse0 = -pulse1;
...
set(gcf, 'Position', [100 100 1200 800])
subplot(2,1,1)
plot(t(1:end/100), x1(1:end/100), 'LineWidth', 1.5)
grid on; grid minor; xlabel('t(s)'); ylabel('x_1(t)'); ylim([-1.5,1.5]);

subplot(2,1,2)
plot(t(1:end/100), x2(1:end/100), 'LineWidth', 1.5)
grid on; grid minor; xlabel('t(s)'); ylabel('x_2(t)'); ylim([-1.5,1.5]);

saveas(gcf,'../report/pics/p2-a-2.png')
%% Analog Modulation
...
saveas(gcf,'../report/pics/p2-a-3.png')
%% Channel 
...
saveas(gcf,'../report/pics/p2-a-4.png')
%% Analog Demod
bw_message = 100;
...
set(gcf, 'Position', [100 100 1200 800])
subplot(2,1,1)
plot(t(1:end/100), y1(1:end/100), 'LineWidth', 1.5);
grid on; grid minor; xlabel('t(s)'); ylabel('y_1(t)'); ylim([-1.5,1.5]);

subplot(2,1,2)
plot(t(1:end/100), y2(1:end/100), 'LineWidth', 1.5);
grid on; grid minor; xlabel('t(s)'); ylabel('y_2(t)'); ylim([-1.5,1.5]);

saveas(gcf,'../report/pics/p2-a-5.png')
%% Matched Filter
...
saveas(gcf,'../report/pics/p2-a-6.png')
